    ...
    <div class="d-flex">
        ...
        <div class="container">
            ...
            <form action="">
                ...
                <label for="">Airtime Phone Number</label><br>
                <input type="text" class="dashboard-inputs" placeholder="Phone Number"><br>
                <label for="">Airtime Amount</label><br>
